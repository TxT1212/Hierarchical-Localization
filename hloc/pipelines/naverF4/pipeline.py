...
parser.add_argument('--dataset', type=Path, default='/media/txt/data2/naver/HyundaiDepartmentStore/4F/release/',
                    help='Path to the dataset, default: %(default)s')
parser.add_argument('--outputs', type=Path, default='/media/txt/data2/naver/outputs/4F/',
...
loc_pairs = Path('/home/txt/Downloads/ezxr_loc/text_hfnet/saved/hfnet_nn_f4_q.txt')
...
# sift_sfm = '/media/txt/data2/naver/HyundaiDepartmentStore/4F/release/sfm_sift'
...
#     query_prefix='2019-08-21_11', db_model=reference_sfm)
loc_matches = match_features.main(
    matcher_conf, loc_pairs, feature_conf['output'], outputs, args.loc_matches)
