...
parser.add_argument('--loc_pairs', type=Path, default='/home/txt/Downloads/ezxr_loc/text_hfnet/saved/hfnet_nn_f1_q.txt',
                    help='Path to the dataset, default: %(default)s')
parser.add_argument('--results', type=Path, default='/media/txt/data2/naver/HyundaiDepartmentStore/outputs/1F/hloc_superpoint+superglue_hhnet_20_.txt',
                    help='Path to the dataset, default: %(default)s')
parser.add_argument('--loc_matches', type=Path, default='/media/txt/data2/naver/HyundaiDepartmentStore/outputs/1F/feats-superpoint-n4096-r1600_matches-superglue_pairs-query-netvlad50.h5',
                    help='Path to the dataset, default: %(default)s')
...
loc_pairs = Path("/home/txt/Downloads/ezxr_loc/text_hfnet/saved/hfnet_nn_org_f1.txt")
loc_pairs = Path("/home/txt/Downloads/ezxr_loc/text_hfnet/saved/hfnet_nn_f1_q.txt")
loc_pairs = args.loc_pairs
results = outputs / f'hloc_superpoint+superglue_netvlad{args.num_loc}.txt'
results = outputs / f'hloc_superpoint+superglue_hhnet_ocr5.txt'
results = args.results

loc_matches = args.loc_matches
# results = outputs / f'hloc_superpoint+superglue_hhnet_20.txt'
...
loc_matches = match_features.main(
    matcher_conf, loc_pairs, feature_conf['output'], outputs, loc_matches)
