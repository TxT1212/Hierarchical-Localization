...
parser.add_argument('--dataset', type=Path, default='/media/txt/data2/naver/HyundaiDepartmentStore/B1/release/',
                    help='Path to the dataset, default: %(default)s')
parser.add_argument('--outputs', type=Path, default='/media/txt/data2/naver/outputs/B1/',
