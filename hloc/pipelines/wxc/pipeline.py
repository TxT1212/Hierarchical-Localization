...
parser.add_argument('--dataset', type=Path, default='/home/ezxr/Documents/wxc/',
                    help='Path to the dataset, default: %(default)s')
parser.add_argument('--outputs', type=Path, default='outputs/wxc/',
...
sift_sfm = '/home/ezxr/Documents/wxc/model'
...
#     query_prefix='2021-01-19/', db_model=reference_sfm)
